...
power_consumption_2007$Voltage <- as.numeric(as.character.numeric_version(power_consumption_2007$Voltage))
...
power_consumption_2007$Global_reactive_power <- as.numeric(as.character.numeric_version(power_consumption_2007$Global_reactive_power))
...
plot(power_consumption_2007$DateTime,power_consumption_2007$Global_active_power,
     ...
     type = "l")
# Voltage
plot(power_consumption_2007$DateTime,power_consumption_2007$Voltage,
     ylab="Voltage",
     xlab="datetime",
     type = "l")
#SubMeterings
...
legend('topright', 
       ...
       cex=.75)
#GRP
plot(power_consumption_2007$DateTime,power_consumption_2007$Global_reactive_power,
